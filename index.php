        ...
        <div class="row">
            <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                ...
                <div class="d-flex justify-content-center justify-content-lg-start">
                    <a href="akun.php?akun=<?php echo $akun; ?>" class="btn-get-started scrollto">Akun</a>
                </div>
            </div>
            <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                <img src="assets/img/sma.png" class="img-fluid animated" alt="" width="300px">
            </div>
        </div>
    </div>
</section>
...
<main id="main">
        ...
        <div class="container-fluid" data-aos="fade-up">
            <div class="row">
                ...
                <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img"
                    style="background-image: url('assets/img/kepalasekolah.png')" data-aos="zoom-in"
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                <div class="col-lg-6">
                    ...
                    <img src="assets/img/visimisi.svg" alt="" height="auto" width="80%">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0">
                    <h1>Misi Sekolah</h1>
                    <p>
    ...
    <section id="contact">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>Cek Pesan Dan Kesan</h2>
                <p>Klik butoon di bawah ini untuk menuju spreadsheets</p>
            </div>
            <center>

                <a
                    href="https://docs.google.com/spreadsheets/d/1P_KrFxjm8-8OeeqBmvbWIAz7EVCIdMPcE5DjdIzvSCs/edit?usp=sharing">
                    <div class="d-grid gap-2 col-6 mx-auto ">
                        <button class="btn btn-outline-primary fw-bold" type="button">Lihat Pesan</button>
                    </div>
                </a>
            </center>
        </div>
